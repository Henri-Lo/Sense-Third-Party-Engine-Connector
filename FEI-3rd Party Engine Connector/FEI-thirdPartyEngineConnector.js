...
define(["jquery", 
        "text!./FEI-thirdPartyEngineConnector.css",
        "./d3.min",
        "./d3.tip.v0.6.3",
        ...
        paint : function($element, layout, lastrow, data, dataPageLimit, noOfDim, noOfMeas) {
            ...
            if(this.backendApi.getRowCount()<10000){
                ...
                if(this.backendApi.getRowCount() == lastrow){
                    ...
                    if(document.getElementById("FEI-thirdpartyengine") != null){
                        document.getElementById("FEI-thirdpartyengine").innerHTML = "";
                    }
                    ...
                    if(layout.masterSwitch == "1"){
                        ...
                        if(layout.engineFunction == "1"){
                            ...
                            if(layout.chartType != "1" && layout.chartType != "2"){
                                $element.html('<p id="FEI-thirdpartyengine">This visualization type is not supported by the selected function.</p>');
                            }
                            else if(layout.qHyperCube.qDimensionInfo.length >= 2 || layout.qHyperCube.qMeasureInfo.length <= 2){
                                $element.html('<p id="FEI-thirdpartyengine">This function requires one date dimension and at least three measures of stock prices. Please make sure the correct dimensions/measures are input and refresh.</p>');
                            }
                            else{
                            ...
                            if(layout.chartType != "3"){
                                ...
                                $element.html('<p id="FEI-thirdpartyengine">This function requires one dimension and one measure. Please make sure the correct dimensions/measures are input and refresh.</p>');
                            }
                            else{
                        ...
                        if(layout.engineFunction == "1"){
                            $element.html('<p id="FEI-thirdpartyengine">This function does not use any dimensions or measures. It is used for testing the connection with the Matlab Production Server.</p>');
                        }
                        else if(layout.engineFunction == "2"){                  
                            if(layout.chartType != "1" && layout.chartType != "2"){
                                $element.html('<p id="FEI-thirdpartyengine">This visualization type is not supported by the selected function.</p>');
                                ...
                                $element.html('<p id="FEI-thirdpartyengine">This function requires one date dimension and at least three measures of stock prices. It is used for allocating investments across various stocks based on historical data. Please make sure the correct dimensions/measures are input and refresh.</p>');
                            }
                        }
                        else if(layout.engineFunction == "3"){
                            if(layout.chartType == "3"){
                                $element.html('<p id="FEI-thirdpartyengine">This function requires one dimension and one measure. It is used for predictive analytics, forecasting with a moving average.</p>');
                            }
                            else{
                                $element.html('<p id="FEI-thirdpartyengine">This visualization type is not supported by the selected function.</p>');
                            }
...
function mpsDiagnostics(element, layout){
    ...
    element.html('<p id="FEI-thirdpartyengine">' + mlResponse.lhs[0].mwdata[0] + '</p>');
}
